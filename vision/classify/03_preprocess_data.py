...
if __name__ == "__main__":
    ...
    # filepath = r".\vision\classify\data\1\1.jpg"
    # f = get_feature(filepath)
    # print(f.shape)
    ...
    for idx in [1,2,30,31,4,50,51,60,61,70,71]:
        rootdir = r'.\vision\classify\data' + '\\' + str(idx)
    ...
    # save
    np.save(r'.\vision\classify\X_data.npy', X_data)
    np.save(r'.\vision\classify\y_data.npy', y_data)
    b = np.load(r'.\vision\classify\X_data.npy')
    a = np.load(r'.\vision\classify\y_data.npy')
    print(b[:2])
    print(a[:20])
